...
Prestataire : **BABYROCK MINERALS, S.L.**, NIF B88957212, Avenida Ramon Escayola 129, 08197 Sant Cugat del Vallès (Barcelone). Contact : [contact@babyrock.ai](mailto:contact@babyrock.ai). Nom commercial : BabyRock. Produit : BabyRock Social.

Client : la personne physique ou morale qui s’inscrit et paie (le « Compte payant »). Un abonnement = un commerce = une fiche d’établissement Google. L’e-mail, le WhatsApp et la carte ne sont pas des identifiants uniques : s’ils correspondent à plusieurs commerces, nous demandons lequel.

Ces conditions s’adressent aux **professionnels**, y compris l’indépendant qui contracte pour son commerce. Si vous agissez en consommateur, les règles impératives de consommation s’appliquent, y compris, le cas échéant, les tribunaux de votre domicile.
...
## 5. Conclusion et paiement

Le contrat se conclut en ligne, sur app.babyrock.ai/pay. Vous cochez que vous acceptez ces conditions et la confidentialité, et vous payez par carte (ou SEPA / Bizum s’il est activé) via Stripe. Stripe prélève périodiquement jusqu’à la résiliation.

Un lien de paiement par WhatsApp ou e-mail est une invitation à contracter. Le contrat naît lorsque vous acceptez et terminez le paiement ou l’essai.

## 6. Durée, renouvellement et résiliation

L’abonnement est mensuel ou annuel, selon le plan, et se renouvelle tout seul.

La résiliation prend effet **à la fin de la période déjà payée**. Vous l’écrivez à Rosalia sur WhatsApp ou à [contact@babyrock.ai](mailto:contact@babyrock.ai). Les réponses déjà publiées restent sur Google. À la fin, nous retirons notre accès gestionnaire. Vous pouvez aussi nous retirer à tout moment dans Google (Paramètres du profil d’entreprise → Personnes et accès → reviews@babyrock.ai → Supprimer).

Si l’essai ne se convertit pas en paiement, nous arrêtons les réponses.
...
En vous abonnant et en nous invitant comme gestionnaire, vous nous autorisez à rédiger, relire, envoyer, modifier et, si besoin, supprimer des réponses sur cette fiche, selon l’article 2.

Google relit chaque réponse et décide quand elle est publique. Un refus ou un retard de Google n’est pas un manquement de notre part.

Vous restez responsable de la fiche. Si elle n’est pas vérifiée, si vous nous retirez l’accès, ou si Google limite l’API, le service s’en ressent ou s’arrête jusqu’à réparation.

## 8. Intelligence artificielle

Nous utilisons des outils d’IA pour aider à préparer les brouillons. Une personne relit et, au besoin, corrige chaque réponse avant publication. Le texte publié est une réponse du commerce, pas un contenu généré et envoyé à l’aveugle.
...
Fournir le service de l’article 2 avec un humain à la publication. Tenir un journal de ce qui a été proposé et publié. Vous prévenir par WhatsApp s’il s’est passé quelque chose dans la journée.

Nous ne promettons ni un nombre d’avis, ni une note moyenne, ni une position Google.

## 11. Disponibilité

Nous travaillons les jours ouvrés. Les avis arrivent sept jours sur sept ; le lundi absorbe le week-end. Une panne Google, Stripe, WhatsApp ou réseau peut retarder une publication.

## 12. Propriété intellectuelle

Les brouillons et le journal sont nôtres, avec une licence pour que vous les utilisiez sur votre fiche. Une fois publiée, la réponse est la réponse publique du commerce sur Google. Vous nous concédez l’usage de l’enseigne et des données de fiche nécessaires au service.

## 13. Données personnelles

Deux rôles, qui ne se mélangent pas :

- **Nous sommes responsables** du traitement de votre compte, de la facturation, du WhatsApp avec vous et du site. Détail : [confidentialité](https://www.babyrock.ai/fr/confidentialite/).
- **Vous êtes responsable** du traitement du contenu des avis et des réponses. Nous sommes **sous-traitants**. L’[accord de traitement](https://www.babyrock.ai/fr/accord-traitement/) (article 28 du RGPD) est accepté avec ces conditions.

## 14. Responsabilité

Nous fournissons le service avec la diligence d’un prestataire professionnel. Nous ne répondons pas :

- des décisions de Google, Meta ou Stripe ;
- du contenu d’un avis écrit par un tiers ;
- d’une baisse de note, de visites ou de chiffre d’affaires (ce n’est pas ce que nous vendons) ;
- d’un texte que vous nous avez demandé de publier.

Nous n’excluons pas la responsabilité pour dol ou faute grave, ni celle que la loi interdit de limiter.

Entre professionnels, l’indemnité pour manquement, s’il y en a une, ne dépassera pas les redevances payées pour le service au cours des douze mois précédant le fait, sauf dol ou faute grave.

## 15. Tiers

Stripe encaisse. Meta (WhatsApp) transporte les messages du Fil Babyrock. Google héberge la fiche et les avis. Chacun a son contrat. Si Google ou Meta change une API ou une règle, nous adaptons le service ou, si c’est impossible, nous l’arrêtons et nous vous le disons.

## 16. Modification

Si nous changeons le texte de façon substantielle, nous vous le dirons par WhatsApp ou e-mail, avec la nouvelle version. Si cela ne vous convient pas, vous résiliez à la fin de la période payée. Continuer à payer après la date d’entrée en vigueur vaut acceptation, sauf norme impérative contraire.

## 17. Cession

Nous pouvons céder le contrat à une autre société du groupe ou à un acquéreur de l’activité, pour le même service. Vous ne pouvez pas céder votre compte sans notre accord écrit.

## 18. Loi et langue

Droit espagnol. Tribunaux de Barcelone, sauf norme impérative de consommation.

Le texte espagnol prévaut sur les versions catalane, française ou anglaise.

## 19. Contact

Résiliation, données et réclamations : [contact@babyrock.ai](mailto:contact@babyrock.ai) ou WhatsApp +34 711 52 09 44.
